...
int main(int argc, char **argv)
{
    ...
    int matrix_result = myMM(argc, argv, devID, matrix_size);
...
int myMM(int argc, char **argv, int devID, sMatrixSize &matrix_size){
    ...
    // create and start timer
    printf("Computing result using myMM_Opt...");
    // execute the kernel
    size_t m = matrix_size.uiHA;
    size_t k = matrix_size.uiWA;
    size_t n = matrix_size.uiWB;
    int lda = matrix_size.uiWA;
    int ldb = matrix_size.uiWB;
    int ldc = matrix_size.uiWC;
